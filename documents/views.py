...
class BackLinkAPI(APIView):
    def get(self, request, title):
        ...
        for currdoc in currdocs:
            ...
            #if 'https://kiwi-client.vercel.app/viewer?title={}'.format(title_encoded) in historydoc.content:
            if 'https://wiki.cau-likelion.org/viewer?title={}'.format(title_encoded) in historydoc.content:
